...
pub fn random() -> String {
  let ua = vec![
    ...
    "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) obsidian/1.6.7 Chrome/124.0.6367.243 Electron/30.5.1 Safari/537.36",
    ...
    "NetworkingExtension/8619.1.26.30.7 Network/4277.2.6 iOS/18.0.1",
